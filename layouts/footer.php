            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0" style="text-align:left;">
                <table style="width:100%;border-collapse: collapse;" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <h5 class="text-uppercase">อุทยานวิทยาศาสตร์ 
                            <br> มหาวิทยาลัยสงขลานครินทร์</h5>
                            หมู่ที่ 6 ตำบลทุ่งใหญ่ อำเภอหาดใหญ่
                            จังหวัดสงขลา <br>90110
                        </td>
                    </tr>
                </table>
...
<!--                <ul class="list-unstyled">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2020 Copyright:
        <a class="text-white" href="https://mdbootstrap.com/">อุทยานวิทยาศาสตร์ภาคใต้</a>
    </div>
    <!-- Copyright -->
</footer>    
